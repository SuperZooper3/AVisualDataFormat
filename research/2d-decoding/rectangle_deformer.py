...
def squarifyRectangle(imageName, rectangleCoordinates): # Where rectangleCoordinates is a list of lists of 2-tuples for coordinates (list of corners)
    ...
    for rectangle in rectangleCoordinates:
        ...
        for point in rectangle:
            ...
            angle = np.arctan2(point[1] - middlePoint[1], point[0] - middlePoint[0])
            # Convert to degrees
    ...
    for i, rectangle in enumerate(adjustedCoordinates):
        ...
        transformationMatrix = cv2.getPerspectiveTransform(rectangle, mappedCoordinates)
